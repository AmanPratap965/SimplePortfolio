...
const authName=document.querySelector(".nameContainer>h2");
const jobTitle1=document.querySelector(".jobTitleContainer1");
const jobTitle2=document.querySelector(".jobTitleContainer2");
const jobTitle1Text=document.querySelector(".jobTitleContainer1>h2");
const jobTitle2Text=document.querySelector(".jobTitleContainer2>h2");
...
window.addEventListener("scroll",()=>{
    ...
    saluteText.style.transform=`translateY(${offsetY*0.3}px)`;
    saluteImg.style.transform=`translate(${offsetY*0.4}px, ${offsetY*0.7}px)`;
    authName.style.transform=`translateX(${-offsetY*0.1}px)`;
    jobTitle1.style.backgroundPositionY=`${offsetY*0.5}px`;
    jobTitle2.style.backgroundPositionY=`${-offsetY*5}px`;
    jobTitle1Text.style.transform = `translateX(calc(200vh - ${offsetY}px))`
    jobTitle2Text.style.transform = `translateX(calc(-300vh + ${offsetY}px))`
})